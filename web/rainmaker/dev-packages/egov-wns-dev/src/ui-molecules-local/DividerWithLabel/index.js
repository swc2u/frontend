...
class DividerWithLabel extends Component {
  render() {
    ...
    if((label.labelKey === "WS_TASK_PROP_OWN_HEADER"  || label.labelKey === 'WS_COMMON_CONNECTION_HOLDER_DETAILS_HEADER') && this.props.propertyOwners &&  this.props.propertyOwners.length > 1){
