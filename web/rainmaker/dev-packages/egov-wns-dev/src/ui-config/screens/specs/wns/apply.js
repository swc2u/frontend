   ...
   // let queryObject = [{ key: "tenantId", value: tenantId }, { key: "applicationNumber", value: applicationNo }];
    ...
    if (getQueryArg(window.location.href, "action") === "edit") {
      ...
      if (applicationNo.includes("SW")) {
        ...
        const textFields = ["ledgerNo","ledgerGroup","noOfToilets","noOfWaterClosets","billGroup","ccCode","ferruleSize"];
...
/////? disable Connection Details fiels  in bellow condition
    if(applicationStatus_ ==='PENDING_FOR_METER_UPDATE'
      ...
      || applicationStatus_ ==='PENDING_FOR_PAYMENT_VERIFICATION_BY_JE_FOR_REACTIVATION'
      || applicationStatus_ ==='PENDING_FOR_SUPERINTENDENT_APPROVAL_AFTER_JE_FOR_REACTIVATION'
      || applicationStatus_ ==='PENDING_FOR_METER_TESTING_BY_JE'
