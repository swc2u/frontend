...
class WorkDashboardOne extends React.Component {
  constructor(props) {
    super(props);
    this.state ={
        graphOneLabel: [],
    ...
    graphSorting = ( propSortBy, sortBy, data, checkGraph ) => {
        ...
        if( checkGraph === "dashboard 3" ){
            ...
            for(var i=0; i<data.length; i++){
                var dtStr = data[i].lastmodifieddate;
                dtStr = dtStr.split(" ")
                dtStr = dtStr[0].split("/")
                dtStr = dtStr[2]+"-"+dtStr[1]+"-"+dtStr[0]

                var keyMonth = month[new Date(dtStr).getMonth()] +" "+ new Date(dtStr).getFullYear();
        ...
        if( checkGraph === "dashboard 4" ){
            ...
            for(var i=0; i<Object.keys(group).length ; i++){
                ...
                for(var j=0; j<group[graphLabel[i]].length; j++){
                    amt = amt + group[graphLabel[i]][j].work_amount
                } 
                graphData.push(amt);
            }
    ...
    render() {
        ...
        var graphOneOption = {
            ...
            title: {
                display: true,
                text: "Work Agreement Project Status Report"
            },
            scales: {
                // xAxes: [{
                //     gridLines: {
        ...
        var graphTwoOption = {
            ...
            title: {
                display: true,
                text: "Department wise Project Status Report"
            },
            scales: {
                xAxes: [{
                    stacked: true,
        ...
        var graphThirdOption = {
            ...
            title: {
                display: true,
                text: "Departmentwise Monthly Project Status Report"
            },
            scales: {
                xAxes: [{
                    stacked: true,
            ...
            onClick: (e, element) => {
                if (element.length > 0) {
                    ...
                    const hardval = this.state.hardJSON[1]
                    var graphSort = this.graphSorting( this.state.propSortBy, "Percentage_Completion", this.state.dataThird[selectedVal], "dashboard 4" );
        ...
        var graphFourthOption = {
            ...
            title: {
                display: true,
                text: "Sectorwise Project Expenditure Monthly"
            },
            scales: {
                xAxes: [{
                    stacked: true,
        ...
        return (
            <div>
            {/* <h2> Work Management Dashboard Graph (Work Agreement) </h2>  */}
...
export default WorkDashboardOne;