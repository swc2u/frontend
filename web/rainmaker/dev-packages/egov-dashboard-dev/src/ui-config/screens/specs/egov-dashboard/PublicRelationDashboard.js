...
import { FilterForm, DashboardResults } from "./PublicRelationDashboard/PublicRelationDashboard";
import './index.css';
...
const header = getCommonHeader(
  {
    labelName: "Public Relation Dashboard",
    labelKey: "PublicRelation_dashboard_1"
  },
  {
    classes: {
...
//   let data = getDashboardDropdownData(state, dispatch, status)
  ...
  var selectedDefaultData = {value: "PUBLISHED", label: "Published Events"};
...
const PublicRelationDashboard = {
  uiFramework: "material-ui",
  name: "PublicRelationDashboard",
