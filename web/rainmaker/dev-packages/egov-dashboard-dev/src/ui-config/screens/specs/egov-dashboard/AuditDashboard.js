...
import { FilterForm, DashboardResults } from "./AuditDashboard/AuditDashboard";
import './index.css';
...
const header = getCommonHeader(
  {
    labelName: "Audit Dashboard",
    labelKey: "Audit_dashboard_1"
  },
  {
    classes: {
...
// const propSortBy = "getAllMeeting";
  var data =  [
    {
    "name" : "Pre Audit Dashboard",
    "code" : "Pre-Audit"
    },
    {
      "name" : "Post Audit Dashboard",
      "code" : "Post-Audit"
    }
  ]
