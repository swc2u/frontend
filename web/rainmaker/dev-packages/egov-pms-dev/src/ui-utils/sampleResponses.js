...
export const ActionButton =()=>{
  return {
    ...
    CLOSE:"CLOSE",
    BACKWORD:"SEND_BACK",
    SEND_BACK_TO_DETAILS_REVIEW:"SEND_BACK_TO_DETAILS_REVIEW",
    SEND_BACK_TO_DETAILS_VERIFICATION:"SEND_BACK_TO_DETAILS_VERIFICATION",
...
export const ActionStep =()=>{
  return {
    ...
    CLOSE :"WF_RRP_SERVICE_CLOSE",
    PENDING_FOR_CALCULATION: "WF_RRP_SERVICE_PENDING_FOR_CALCULATION",
    PENDING_FOR_AUDIT: "WF_RRP_SERVICE_PENDING_FOR_CONTINGENT_BILL_PREPARATION_WITH_CLERK"
};
}
export const ActionStepDoe =()=>{
  return {
    INITIATED: "WF_DOE_SERVICE_INITIATED",
    CLOSE :"WF_DOE_SERVICE_CLOSE",
    PENDING_FOR_CALCULATION: "WF_DOE_SERVICE_PENDING_FOR_CALCULATION",
    PENDING_FOR_AUDIT: "WF_DOE_SERVICE_PENDING_FOR_CONTINGENT_BILL_PREPARATION_WITH_CLERK"
};
}
export const ActionStepDop =()=>{
  return {
    INITIATED: "WF_DOP_SERVICE_INITIATED",
    CLOSE :"WF_DOP_SERVICE_CLOSE",
    PENDING_FOR_CALCULATION: "WF_DOP_SERVICE_PENDING_FOR_CALCULATION",
    PENDING_FOR_AUDIT: "WF_DOP_SERVICE_PENDING_FOR_CONTINGENT_BILL_PREPARATION_WITH_CLERK"
};
}
...
export const ActionMessage =()=>{ 
  return {
    ...
    localization:[
      {
        PENSION_ERR_DISABILITY_REQUIRED_VALIDATION:
        {
          key:"PENSION_ERR_DISABILITY_REQUIRED_VALIDATION",
          value:"Please fill all mandatory fields then submit!"
        },
        PENSION_EMPLOYEE_DISABILITY_SEVERITY:
        {
          key:"PENSION_EMPLOYEE_DISABILITY_SEVERITY",
          value:"Select severityOfDisability"
        }
...
export const ActionWorkflowAccessibility =()=>{
  return {
    ...
    InActiveReleaseMessage:'Task cannot be released as it is not claimed by you.',
...
businessServiceDOE:"DOE_SERVICE",
    businessServiceDOP:"DOP_SERVICE",
    ReasionOfRetirement_DOP: "DEATH_AS_PENSIONER",
    ReasionOfRetirement_DOE: "DEATH_AS_EMPLOYEE",
    PENDING_FOR_CALCULATION:"PENDING_FOR_CALCULATION",
    DISABILITY_SUBMIT_YEAR: 5,
  }
}
...
export const ApplicationConfiguration =()=>{
  ...
  return{
    FilestoreId_key:"pension",
    RRP_APPLICATION:"rrp_application_form",
    RRP_APPLICATION_config:true,
    RRP_PAYMENT_ORDER:"rrp_payment_order",
    RRP_PAYMENT_ORDER_config:true,
    RRP_PAYMENT_ORDER_DAILY_WAGER:"rrp_payment_order_daily_wager",
    RRP_PAYMENT_ORDER_DAILY_WAGER_config:true,
    EMPLOYEE_TYPE:"DAILYWAGES",
    DOP_APPLICATION:"dop_application_form",
    DOP_APPLICATION_config:true,
    DOP_PAYMENT_ORDER:"dop_payment_order",
    DOP_PAYMENT_ORDER_config:true,
    DOE_APPLICATION:"doe_application_form",
