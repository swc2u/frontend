...
export const footer = (Accesslabledata) => {
  //alert(Accesslable[0].employeeOtherDetailsUpdate)
  ...
  {  
    ...
    {  
      ...
      if(!Accesslable[0].employeeOtherDetailsUpdate)
      {
        ...
        downloadAcknowledgementForm(pdfResponce.ApplicationDetails,config.DOE_APPLICATION,config.DOE_APPLICATION_config); 
      }
...
const changeStep = (
 ...
 const actionDefination = [
  ...
  dispatchMultipleFieldChangeAction("doeDetails", actionDefination, dispatch);
