import {
  ...
  const pensionerUpdate = async (state, dispatch) => {  
    ...
    window.location.href = `updatePensionerDetails?pensionerNumber=${pensionerNumber}&tenantId=${tenantId}`;//&pensionerNumber=${rowData[6]}`;
  }
