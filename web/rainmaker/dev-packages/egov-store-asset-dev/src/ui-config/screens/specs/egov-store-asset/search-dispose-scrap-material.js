import {
  ...
  import { searchForm } from "./searchDisposalResourse/searchForm";
  import { searchResults } from "./searchDisposalResourse/searchResults";
  ...
  const addPurchaseOrderHandle = async (state, dispatch) => {
    dispatch(setRoute(`/egov-store-asset/create-dispose-scrap-material`));
  };
  ...
  const purchaseOrderSearchAndResult = {
    ...
    name: "search-dispose-scrap-material",
