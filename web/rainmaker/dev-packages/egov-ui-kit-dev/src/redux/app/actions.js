...
export const fetchLocalizationLabel = (locale, module, tenantId) => {
  return async (dispatch) => {
    // const commonModules =
    // "rainmaker-pgr,rainmaker-pt,rainmaker-tl,finance-erp,rainmaker-common,rainmaker-hr,rainmaker-uc,rainmaker-noc,rainmaker-abg,rainmaker-bpareg,rainmaker-ws,rainmaker-dss,rainmaker-bpa,rainmaker-pm,rainmaker-pension,rainmaker-pr,rainmaker-hc,rainmaker-ec,rainmaker-store-asset,rainmaker-nulm,rainmaker-services";
