...
import { TextfieldWithIcon, Tooltip } from "egov-ui-framework/ui-molecules/index.js";
...
import {
  ...
  getLocaleLabels,
  appendModulePrefix
} from "egov-ui-framework/ui-utils/commons.js";
...
class TextFieldContainer extends React.Component {
  ...
  render() {
    ...
    let readOnlyEnable = (readOnlyValue === true) ? true : false
