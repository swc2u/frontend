...
import { handleSubmit,handleReject,handlesave,handleApprove,handleApprovalAwait } from "./functions";

const gotoCreateFlow = (state, dispatch) => {
  const createUrl = `/egov-nulm/create-smid-org`;
...
const getRoleBaseViewButton = () => {
  ...
  approvalAwaitButton: {
    ...
    children: {
      resetButtonLabel: getLabel({
        labelName: "Forward for Approval",
        labelKey: "NULM_COMMON_FRWD_APPOVAL_BUTTON",
      }),
    },
    onClickDefination: {
      action: "condition",
      callBack: handleApprovalAwait,
    },
    visible: true,
  }
}
