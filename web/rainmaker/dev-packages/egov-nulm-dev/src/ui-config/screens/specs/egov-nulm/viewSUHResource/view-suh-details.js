  ...
  return getCommonGrayCard({
    ...
    viewOne: getCommonContainer({
      nameOfShelter: getLabelWithValue(
        ...
        { jsonPath: "NulmSuhRequest.nameOfShelter" ,callBack: checkValueForNA }
      ),
      address: getLabelWithValue(
        ...
        { jsonPath: "NulmSuhRequest.address" ,callBack: checkValueForNA }
      ),
      shelterBackground: getLabelWithValue(
        ...
        { jsonPath: "NulmSuhRequest.shelterBackground" ,callBack: checkValueForNA }
      ),
      ...
      category: getLabelWithValue(
        ...
        { jsonPath: "NulmSuhRequest.category" ,callBack: checkValueForNA }
      ),
      ...
      weatherCondition: getLabelWithValue(
        ...
        { jsonPath: "NulmSuhRequest.weatherCondition"  ,callBack: checkValueForNA}
      ),
      ...
      shelterClassification: getLabelWithValue(
        ...
        { jsonPath: "NulmSuhRequest.shelterClassification" ,callBack: checkValueForNA }
      ),
      otherClassification: getLabelWithValue(
        ...
        { jsonPath: "NulmSuhRequest.otherClassification" ,callBack: checkValueForNA }
      ),
      ownership: getLabelWithValue(
        ...
        { jsonPath: "NulmSuhRequest.ownership" ,callBack: checkValueForNA }
      ),
      ...
      operationAndManagementOfShelters: getLabelWithValue(
        ...
        { jsonPath: "NulmSuhRequest.operationAndManagementOfShelters" ,callBack: checkValueForNA }
      ),
      area: getLabelWithValue(
        ...
        { jsonPath: "NulmSuhRequest.area" ,callBack: checkValueForNA }
      ),
      capacity: getLabelWithValue(
        ...
        { jsonPath: "NulmSuhRequest.capacity" ,callBack: checkValueForNA }
      ),
      assignedTo: getLabelWithValue(
        ...
        { jsonPath: "NulmSuhRequest.assignedToName" ,callBack: checkValueForNA }
      ),
    }),
  });
};
