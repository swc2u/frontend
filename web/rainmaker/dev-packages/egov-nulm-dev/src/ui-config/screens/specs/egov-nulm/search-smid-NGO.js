import {
  ...
  import { searchForm } from "./searchALFResource/searchForm";
  import { searchResults } from "./searchALFResource/searchResults";
  ...
  const header = getCommonHeader({
    labelName: "Application for SMID NGO program",
    labelKey: "NULM_APPLICATION_FOR_SMID_NGO_PROGRAM",
  });
  
  const createALFHandle = async (state, dispatch) => {
    dispatch(setRoute(`/egov-nulm/create-alf`));
  };
  ...
  const smidNGOSearchAndResult = {
    uiFramework: "material-ui",
    name: "search-smid-NGO",
          ...
          headerDiv: {
            ...
            children: {
              ...
              newApplicationButton: {
                ...
                visible: process.env.REACT_APP_NAME === "Employee"? true : true,
                props: {
                  variant: "contained",
                  color: "primary",
                  style: {
                ...
                children: {
                  ...
                  buttonLabel: getLabel({
                    labelName: "Add ALF",
                    labelKey: "NULM_ADD_NEW_ALF_BUTTON",
                  }),
                },
                onClickDefination: {
                  action: "condition",
                  callBack: createALFHandle,
                },
              },
            },
          },
  ...
  export default smidNGOSearchAndResult;
