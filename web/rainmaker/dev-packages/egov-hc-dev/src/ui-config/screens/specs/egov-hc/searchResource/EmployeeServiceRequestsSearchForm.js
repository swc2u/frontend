...
import { searchApiCallForEmployeeFilter, searchApiCallForEmployeeReport } from "./functions";
import { resetFieldsForEmployeeFilter, resetFieldsForEmployeeReport } from "./citizenSearchFunctions";
...
export const ServiceRequestFilterFormForReport = getCommonCard({
...
serviceRequestidContactNoAndRequestTypeContainer: getCommonContainer({
    ...
    ownerName: {
      ...
      //  type:"number",
        ...
        jsonPath: "serviceRequests.ownerName"
      })
    },
  ...
  sourceJsonPath: "applyScreenMdmsData.eg-horticulture.assignedToUserList",
  jsonPath: "serviceRequests.assignedTo",
    ...
    buttonContainer: getCommonContainer({
      searchButton: {
        ...
        onClickDefination: {
          action: "condition",
          callBack: (state, dispatch) => {
            searchApiCallForEmployeeReport(state, dispatch)
          }
        }
      },
      resetButton: {
        ...
        onClickDefination: {
          action: "condition",
          callBack: resetFieldsForEmployeeReport
