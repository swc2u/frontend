...
import LinearProgress from "../dev-packages/egov-ui-framework-core/src/ui-atoms/LinearSpinner";
import Loadable from "react-loadable";
import Item from "../dev-packages/egov-ui-framework-core/src/ui-atoms/Layout/Item";
  ...
  componentDidMount() {
    ...
    switch (uiFramework) {
      ...
      case "custom-atoms":
        LoadableComponent = Loadable({
          loader: () =>
            import("../dev-packages/egov-ui-framework-core/src/ui-atoms").then(module => module[componentPath]),
          loading: () => <LinearProgress />
        });
        break;
      case "custom-molecules":
        LoadableComponent = Loadable({
          loader: () =>
            import("../dev-packages/egov-ui-framework-core/src/ui-molecules").then(module => module[componentPath]),
          loading: () => <LinearProgress />
        });
        break;
      case "custom-containers":
        LoadableComponent = Loadable({
          loader: () =>
            import("../dev-packages/egov-ui-framework-core/src/ui-containers").then(module => module[componentPath]),
          loading: () => <LinearProgress />
        });
        break;
