...
import img from "egov-ui-kit/assets/images/people.png";
    ...
    return (
        ...
        <div className="profile-card-container">
          <div>
            ...
            <ProfileSection img={img} addIconName={false}  />
            </div>
            ...
            <Grid item xs={12} sm={6} md={4}lg={3} style={{ marginTop: 10, paddingRight: 10 ,paddingLeft: 10 }}>
                              ...
                              <LabelContainer labelName="dcrgVerified" labelKey="CS_HELP_CONTACT_LABLE" />
                              </Typography>
                            ...
                            <Grid item xs={12} sm={6} md={4}lg={3} style={{ marginTop: 10, paddingRight: 10 ,paddingLeft: 10 }}>
                              <Typography variant="caption">
                              <LabelContainer labelName="dcrgVerified" labelKey="CS_HELP_EMAIL_LABLE" />
                              </Typography>
                              <Typography variant="body2">
