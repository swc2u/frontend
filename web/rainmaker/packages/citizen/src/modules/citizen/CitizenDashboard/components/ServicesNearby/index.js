...
class ServicesNearby extends React.Component {
  ...
  render() {
    ...
    return (
      <Grid container>
        <Grid item xs={6} sm={6} align="center" style={{ paddingLeft : 8,cursor: "pointer",marginLeft:-2 }}  onClick={() => onServiceClick("events")}>
        ...
        <Grid item xs={6} sm={6} align="center" style={{ cursor: "pointer",paddingLeft:10 }}  onClick={() => onServiceClick("my-city")}>
          <Card className="servicelist-style"
            textChildren={
              <div className="local-information-cont" >
